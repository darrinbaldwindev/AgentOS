...
test('issuer and target mismatches are rejected', () => {
  assert.throws(() => validateDispatchTask(task, {
    issuer: 'Other Agent',
    target: 'AgentOS Overseer Project',
  }), /issuer mismatch/);
  assert.throws(() => validateDispatchTask(task, {
