...
const task = { task_id: 'wake-idem-001', issuer: 'agentos:overseer', target: 'agentos:project-overseer', objective: 'bounded action', priority: 'high', scope: ['repository'], constraints: ['no external side effects'], authority: { action: 'execute' }, status: 'queued', created_at: '2026-09-02T00:00:00Z' };
