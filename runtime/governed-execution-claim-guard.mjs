...
function exactIdentityMismatch(claim, task) {
  return (claim.mission_id != null && task.mission_id != null && claim.mission_id !== task.mission_id) ||
    (claim.task_id != null && task.task_id != null && claim.task_id !== task.task_id) ||
    (claim.wake_trace_id != null && task.wake_trace_id != null && claim.wake_trace_id !== task.wake_trace_id);
}
